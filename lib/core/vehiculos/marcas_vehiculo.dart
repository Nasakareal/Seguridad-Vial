...
class MarcasVehiculo {
  ...
  static const List<MarcaVehiculoOption> opciones = [
    ...
    MarcaVehiculoOption('AKT', tipos: [motocicleta]),
    ...
    MarcaVehiculoOption('DAYUN', tipos: [motocicleta]),
    ...
    MarcaVehiculoOption('ISLO', tipos: [motocicleta]),
    ...
    MarcaVehiculoOption('JIALING', tipos: [motocicleta]),
    ...
    MarcaVehiculoOption('MERCURY', tipos: [automovil, camioneta]),
    ...
    MarcaVehiculoOption('OLDSMOBILE', tipos: [automovil]),
    ...
    MarcaVehiculoOption('SATURN', tipos: [automovil, camioneta]),
    MarcaVehiculoOption('SCANIA', tipos: [camion]),
    MarcaVehiculoOption('SCION', tipos: [automovil]),
    MarcaVehiculoOption('SCOTT', tipos: [bicicleta]),
    MarcaVehiculoOption('SDLG', tipos: [maquinaria]),
    MarcaVehiculoOption('SENKE', tipos: [motocicleta]),
    ...
    MarcaVehiculoOption('WINMEX', tipos: [motocicleta]),
    ...
    MarcaVehiculoOption('ZONGSHEN', tipos: [motocicleta]),
